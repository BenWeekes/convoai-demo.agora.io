...
export function VideoAvatarClient() {
  ...
  // Photo-call demo: local video is never shown, so don't create or publish
  // a camera track. Without this the laptop camera indicator stays lit.
              ...
              <div className="w-2/5 min-w-0 rounded-lg border bg-card shadow-lg overflow-hidden flex flex-col">
                ...
                >
                  <ConversationContent className="gap-3">
                    ...
                    {currentInProgressMessage &&
                      (() => {
                        const isAgent = !meetingMode && isAgentMessage(currentInProgressMessage.uid);
                        const ownMeetingMessage = isOwnMeetingMessage(currentInProgressMessage);
                        const label = meetingMode
